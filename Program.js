    ...
    <div className='program-parent'>
      ...
      <div className='program-main' data-aos='zoom-in'>
        <div className='program-child' data-aos='fade-up'>
          <p><img className='program-image' src="image4.png" alt="Flex Muscle"/></p>
        ...
        <div className='program-child' data-aos='fade-up'>
          <p><img className='program-image1' src="image5.png" alt="Flex Muscle"/></p>
          <p className='program-letter'>Flex Muscle</p>
        ...
        <div className='program-child' data-aos='fade-up'>
          <p><img className='program-image2' src="image6.png" alt="Flex Muscle"/></p>
          <p className='program-letter'>Flex Muscle</p>
        ...
        <div className='program-child' data-aos='fade-up'>
          <p><img className='program-image3' src="image7.png" alt="Flex Muscle"/></p>
          <p className='program-letter'>Flex Muscle</p>
